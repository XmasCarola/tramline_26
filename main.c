...
void fromIASLtoSLL(struct indexes_array_list * W, int S, struct singly_liked_list ** doublePointer, int key) {
...
int main() {
    ...
    fromIASLtoSLL(IAListPointer1, S, &fromIASLtoSLLPointer, key);
